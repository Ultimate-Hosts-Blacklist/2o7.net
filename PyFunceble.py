...
class Settings(object):  # pylint: disable=too-few-public-methods
    ...
    travis_autosave_final_commit = "[Results] Test of 2o7.net for Ultimate Hosts Blacklist"
    # Default travis commit message
    travis_autosave_commit = "[Autosave] Test of 2o7.net for Ultimate Hosts Blacklist"
    ...
    # Current directory.
    current_dir = '/home/travis/build/Ultimate-Hosts-Blacklist/2o7.net/'
